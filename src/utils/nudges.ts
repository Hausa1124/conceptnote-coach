...
const sectorBase: Record<string, Partial<Step2Guidance>> = {
  ...
  Education: {
    ...
    problemHint: "Who is behind? Where? What metrics prove it?",
    objectivesHint: "Tie to literacy/numeracy metrics with a date.",
  },
  WASH: {
    problemPlaceholder: "Explain access/quality gap (water distance, latrines, hygiene).",
    ...
    objectivesHint: "Include a % or count and a month/year.",
  },
  Agriculture: {
    ...
    problemHint: "Mention crop, district, farmer segment.",
  ...
  "Economic Development": {
    ...
    objectivesHint: "Use counts or % and a deadline.",
  },
};

const donorAdds: Record<string, string[]> = {
  EU: ["Keep SMART, align to logframe."],
  USAID: ["Reference RF/CDCS if relevant."],
  UN: ["Map to SDGs briefly."],
  FAO: ["Emphasize smallholders & markets."],
};
...
export function getStep2Guidance(sector: string, donor: string): Step2Guidance {
  ...
  return {
    problemPlaceholder: s.problemPlaceholder || "Describe the core problem, who is affected, and evidence.",
    objectivesPlaceholder: s.objectivesPlaceholder || "Write 2–3 SMART objectives with numbers and a timeframe.",
